...
import { ChefHat, ClipboardList, Eye, Plus, UserRound } from 'lucide-react';
...
const linkedFunctionsFor = (service, functions) => {
  ...
  return functions.filter((item) => ids.has(idOf(item)) || (!ids.size && (item.linkedServices || []).includes(serviceName)));
};
