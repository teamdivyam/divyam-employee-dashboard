...
export default function EventAccommodationPage() {
  ...
  const saveProperty = (payload, propertyId) => propertyId ? updatePropertyMutation.mutateAsync({ propertyId, ...payload }) : createPropertyMutation.mutateAsync(payload);
